...
class CLIPElectraFusion(nn.Module):
    ...
    def __init__(self, clip_model, electra_model,
        ...
        # Layer proyeksi untuk gambar: `img_dim -> fusion_img_dim`.
        # Jika dimensinya sama, gunakan `Identity` agar tidak ada transformasi tambahan.
        ...
        # Layer proyeksi untuk teks: `electra_hidden_dim -> fusion_text_dim`.
        # Jika dimensinya sama, gunakan `Identity` agar tidak ada transformasi tambahan.
        ...
        # Tentukan dimensi hasil fusi berdasarkan metode yang dipilih.
    ...
    def forward(self, pixel_values, input_ids, attention_mask):
        ...
        # Proyeksikan fitur gambar ke dimensi fusi.
        ...
        # Proyeksikan embedding teks ke dimensi fusi atau gunakan `Identity` jika sama.
        ...
        if self.fusion_method == 'concatenate':
            ...
            # Bentuk dua token modalitas `[image, text]`, lalu ringkas dengan mean pooling.
        ...
        # Hasil fusi diteruskan ke classifier.
        logits = self.classifier(fused_rep)

        # Kembalikan juga fitur gambar dan teks untuk kebutuhan analisis.
