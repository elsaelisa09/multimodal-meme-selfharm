...
# Dataset untuk data multimodal (teks + gambar).
class MultimodalDataset(Dataset):
    ...
    # Ambil satu sampel dan kembalikan dictionary berisi citra, token, mask, dan label.
    ...
    # Gabungkan beberapa sampel menjadi satu batch untuk proses training/evaluasi.
    @staticmethod
